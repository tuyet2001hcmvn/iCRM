...
{
    public class ConsultingDesignController : BaseController
    {
        // GET: ConsultingDesign
        public ActionResult _List(Guid? id, bool? isLoadContent = false)
        {
            return ExecuteSearch(() =>
            {
                var result = (from p in _context.ProfileModel
                              ...
                              where a.ProfileId == id && a.PartnerType == ConstPartnerType.ThietKe //Thiết kế
        ...
        public ActionResult Save(Guid? ProfileId, Guid? PartnerId)
        {
            ...
            {
                var existsPartner = _context.Profile_Opportunity_PartnerModel.Where(p => p.ProfileId == ProfileId && p.PartnerType == ConstPartnerType.ThietKe).FirstOrDefault();
                #region Create
                ...
                partner.PartnerType = ConstPartnerType.ThietKe; //Thiết kế
                ...
                return Json(new
                {
                    ...
                    Success = true,
                    Data = string.Format(LanguageResource.Alert_Create_Success, LanguageResource.TabConsultingDesign.ToLower()),
        ...
        public ActionResult SetMain(Guid? OpportunityPartnerId)
        {
            return ExecuteContainer(() =>
            {
                ...
                if (partner != null)
                {
                    ...
                    var remainPartner = _context.Profile_Opportunity_PartnerModel.Where(p => p.ProfileId == partner.ProfileId && p.OpportunityPartnerId != OpportunityPartnerId && p.PartnerType == ConstPartnerType.ThietKe).ToList();
                    ...
                    return Json(new
                    {
                        Code = System.Net.HttpStatusCode.Created,
                        Success = true,
                        Data = string.Format(LanguageResource.Alert_Edit_Success, LanguageResource.TabConsultingDesign.ToLower()),
        ...
        public ActionResult Delete(Guid id)
        {
            return ExecuteDelete(() =>
            {
                ...
                if (design != null)
                {
                    ...
                    var remainDesign = _context.Profile_Opportunity_PartnerModel.Where(p => p.ProfileId == ProfileId && p.PartnerType == ConstPartnerType.ThietKe).ToList();
