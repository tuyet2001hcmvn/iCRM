...
{
    public class ConsultingUnitController : BaseController
    {
        // GET: ConsultingUnit
        public ActionResult _List(Guid? id, bool? isLoadContent = false)
        {
            return ExecuteSearch(() =>
            {
                var result = (from p in _context.ProfileModel
                              ...
                              where a.ProfileId == id && a.PartnerType == ConstPartnerType.DonViTuVan //Đơn vị tư vấn
        ...
        public ActionResult Save(Guid? ProfileId, Guid? PartnerId)
        {
            ...
            {
                var existsPartner = _context.Profile_Opportunity_PartnerModel.Where(p => p.ProfileId == ProfileId && p.PartnerType == ConstPartnerType.DonViTuVan).FirstOrDefault();
                #region Create
                ...
                partner.PartnerType = ConstPartnerType.DonViTuVan; //Đơn vị tư vấn giám sát
                ...
                return Json(new
                {
                    ...
                    Success = true,
                    Data = string.Format(LanguageResource.Alert_Create_Success, LanguageResource.TabConsultingUnit.ToLower()),
        ...
        public ActionResult SetMain(Guid? OpportunityPartnerId)
        {
            return ExecuteContainer(() =>
            {
                ...
                if (partner != null)
                {
                    ...
                    var remainPartner = _context.Profile_Opportunity_PartnerModel.Where(p => p.ProfileId == partner.ProfileId && p.OpportunityPartnerId != OpportunityPartnerId && p.PartnerType == ConstPartnerType.DonViTuVan).ToList();
                    ...
                    return Json(new
                    {
                        Code = System.Net.HttpStatusCode.Created,
                        Success = true,
                        Data = string.Format(LanguageResource.Alert_Edit_Success, LanguageResource.TabConsultingUnit.ToLower()),
